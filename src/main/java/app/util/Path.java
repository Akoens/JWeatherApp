...
public class Path {
    public static class Web {
        ...
        @Getter public static final String DETAILS = "/details/:continent/:stationID/";
    ...
    public static class Template {
        ...
        public static final String DETAILS_AFRICA = "/velocity/details/details_africa.vm";
        public static final String DETAILS_EURASIA = "/velocity/details/details_eurasia.vm";
    }
}
